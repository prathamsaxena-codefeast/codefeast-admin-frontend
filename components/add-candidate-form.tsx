    ...
    <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setForm({
                  ...form,
                  resume: { ...form.resume, summary: e.target.value },
                })
              }
                ...
                <div key={`skill-${idx}`} className="flex items-center gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setForm({
                        ...form,
                        resume: { ...form.resume, skills: next },
                      });
                    }}
                  />
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      const next = form.resume.skills.filter(
                        (_, i) => i !== idx
                      );
                      setForm({
                        ...form,
              ...
              >
                <div className="grid grid-cols-2 gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setForm({
                        ...form,
                        resume: { ...form.resume, experience: next },
                      });
                    }}
                  />
                  <Input
                  ...
                  <div className="mt-3">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        next[idx] = {
                          ...next[idx],
                          highlights: [...next[idx].highlights, ""],
                        };
                        setForm({
                          ...form,
                          resume: { ...form.resume, experience: next },
                    ...
                    {exp.highlights.map((h, hIdx) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const next = [...form.resume.experience];
                            const hi = next[idx].highlights.filter(
                              (_, i) => i !== hIdx
                            );
                            next[idx] = {
                              ...next[idx],
                              highlights: hi.length ? hi : [""],
                            };
                            setForm({
                              ...form,
                              resume: { ...form.resume, experience: next },
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    variant="subtleDestructive"
                    onClick={() => {
                      const next = form.resume.experience.filter(
                        (_, i) => i !== idx
                      );
                      setForm({
                        ...form,
              ...
              >
                <div className="grid grid-cols-2 gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setForm({
                        ...form,
                        resume: { ...form.resume, projects: next },
                      });
                    }}
                  />
                  <Input
                    ...
                    {p.techStack.map((t, tIdx) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const next = [...form.resume.projects];
                            const ts = next[idx].techStack.filter(
                              (_, i) => i !== tIdx
                            );
                            next[idx] = {
                              ...next[idx],
                              techStack: ts.length ? ts : [""],
                            };
                            setForm({
                              ...form,
                              resume: { ...form.resume, projects: next },
                    ...
                    {p.highlights.map((h, hIdx) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const next = [...form.resume.projects];
                            const hs = next[idx].highlights.filter(
                              (_, i) => i !== hIdx
                            );
                            next[idx] = {
                              ...next[idx],
                              highlights: hs.length ? hs : [""],
                            };
                            setForm({
                              ...form,
                              resume: { ...form.resume, projects: next },
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    variant="subtleDestructive"
                    onClick={() => {
                      const next = form.resume.projects.filter(
                        (_, i) => i !== idx
                      );
                      setForm({
                        ...form,
      ...
      {currentStep === "review" && (
        <div className="space-y-4">
          ...
          (form.resume.skills || []).filter(Boolean).length ? (
            <div className="rounded-md border p-3 space-y-1 text-sm">
              <div className="font-medium">Summary & Skills</div>
              {form.resume.summary?.trim() && (
                <div>Summary: {form.resume.summary}</div>
              )}
              {(form.resume.skills || []).filter(Boolean).length > 0 && (
                <div>
                  Skills:{" "}
                  {(form.resume.skills || []).filter(Boolean).join(", ")}
                </div>
              )}
            </div>
          ) : null}
